const processActiveContracts = (result) => {
  ...
  let columns = [
    ...
    { key: "SoldToPartner", label: "Sold To Partner" },
  ...
  for (let con of result.dataList) {
    let row = {
      ...
      cellData: [
        ...
        { key: con.Id + "Account", wideCell: true, data: con.Account.Name, isLookup: true, lookupId: con.AccountId },
        ...
        {
          key: con.Id + "SoldToPartner",
          data: con.Sold_to_Partner__r?.Name,
          isLookup: true,
          lookupId: con.Sold_to_Partner__c
        },
        {
          key: con.Id + "Amount",
          isCurrency: true,
      ...
      drawerData: [
        ...
        },
        {
          ...
          label: "Pricebook",
          data: con.SBQQ__Opportunity__r?.Pricebook2?.Name,
          isLookup: true,
          lookupId: con.SBQQ__Opportunity__r?.Pricebook2Id
        },
        {
          key: con.Id + "PrimarySubsidiary",
          label: "Primary Subsidiary",
          data: con.Account?.Primary_Subsidiary__c,
          isLookup: true,
          lookupId: con.Account?.Primary_Subsidiary__c
        }
      ]
      // ,
      // rowActionData: [
