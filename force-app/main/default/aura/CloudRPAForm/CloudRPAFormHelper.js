            ...
            $A.getCallback (function (results) {
                ...
                if (results && results !== null && results !== undefined) {
                    ...
                    for(var i = 0;i<results[7].length;i++){
                        //console.log('asdf'+results[7][i].label+' '+results[7][i].isSelected);
                        if(results[7][i].value =='' || results[7][i].value == 'Cloud Platform' || results[7][i].value == 'Integration Services'){
                            if(results[7][i].value ==''){
                                results[7][i].isSelected = true;   
                            }                            
                            withoutPortal.push(results[7][i]);
                        }
                    }
                    console.log('withoutPortal',withoutPortal);
