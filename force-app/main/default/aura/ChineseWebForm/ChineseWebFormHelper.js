({
    ...
    onCaseSuccess : function (component) {
        component.set("v.showLoadingSpinner", false);
        let successMessage = $A.get("$Label.c.SupportFormSuccess"); 
        this.createModal (component, true, successMessage, $A.get("$Label.c.Case_Success_Message"));
    },
